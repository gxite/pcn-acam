...
def main():
    ...
    #out_vid_path = '/home/guoxiang/Desktop/action_test_visualized.mp4'
    ...
    if not display:
        #writer.close()    #this was for imageio
        writer.release()   #this is for opencv
